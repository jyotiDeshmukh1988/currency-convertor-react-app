...
const Convertor = () => {
    ...
    if (amount === isNaN) {
      ...
      const getCurrencyconvertTor = async () => {
        const response = await axios.get(
          `https://api.apilayer.com/exchangerates_data/latest?symbols=${convertTo}&base=${base}`,{
            headers: {
                apikey:'BEOwfBYuZQKxi8Z2oaYeLj1Ny6051sva'//the token is a variable which holds the token
            }
        });
  ...
  return (
    <div className="container ml-5">
      <div className="row">
        <div style={{ padding: "30px", background: "#ececec",margin:"30px auto"}}>
          <Card
          ...
          >
            ...
            <h6>As of from today's date <strong>{amount === "" ? "" : date === null ? "" : date}</strong></h6>
            <div className="row">
